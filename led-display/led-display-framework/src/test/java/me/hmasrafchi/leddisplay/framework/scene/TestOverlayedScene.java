...
public final class TestOverlayedScene {
	...
	public void test() {
		...
		final List<List<RgbColor>> expectedColors1 = Arrays.asList(
				Arrays.asList(RgbColor.RED, RgbColor.RED, RgbColor.RED, RgbColor.RED, RgbColor.RED),
				Arrays.asList(RgbColor.YELLOW, RgbColor.BLACK, RgbColor.BLACK, RgbColor.BLACK, RgbColor.YELLOW),
				Arrays.asList(RgbColor.RED, RgbColor.BLACK, RgbColor.BLACK, RgbColor.BLACK, RgbColor.RED),
				Arrays.asList(RgbColor.YELLOW, RgbColor.BLACK, RgbColor.BLACK, RgbColor.BLACK, RgbColor.YELLOW),
				Arrays.asList(RgbColor.RED, RgbColor.BLACK, RgbColor.BLACK, RgbColor.BLACK, RgbColor.RED),
				Arrays.asList(RgbColor.RED, RgbColor.RED, RgbColor.RED, RgbColor.RED, RgbColor.RED));
		...
		final List<List<RgbColor>> expectedColors3 = Arrays.asList(
				Arrays.asList(RgbColor.RED, RgbColor.RED, RgbColor.RED, RgbColor.RED, RgbColor.RED),
				Arrays.asList(RgbColor.YELLOW, RgbColor.BLACK, RgbColor.BLACK, RgbColor.GREEN, RgbColor.YELLOW),
				Arrays.asList(RgbColor.RED, RgbColor.BLACK, RgbColor.BLACK, RgbColor.GREEN, RgbColor.RED),
				Arrays.asList(RgbColor.YELLOW, RgbColor.BLACK, RgbColor.BLACK, RgbColor.GREEN, RgbColor.YELLOW),
				Arrays.asList(RgbColor.RED, RgbColor.BLACK, RgbColor.BLACK, RgbColor.BLACK, RgbColor.RED),
				Arrays.asList(RgbColor.RED, RgbColor.RED, RgbColor.RED, RgbColor.RED, RgbColor.RED));
		...
		final List<List<RgbColor>> expectedColors4 = Arrays.asList(
				Arrays.asList(RgbColor.RED, RgbColor.RED, RgbColor.RED, RgbColor.RED, RgbColor.RED),
				Arrays.asList(RgbColor.YELLOW, RgbColor.BLACK, RgbColor.GREEN, RgbColor.GREEN, RgbColor.YELLOW),
				Arrays.asList(RgbColor.RED, RgbColor.BLACK, RgbColor.GREEN, RgbColor.BLACK, RgbColor.RED),
				Arrays.asList(RgbColor.YELLOW, RgbColor.BLACK, RgbColor.GREEN, RgbColor.GREEN, RgbColor.YELLOW),
				Arrays.asList(RgbColor.RED, RgbColor.BLACK, RgbColor.BLACK, RgbColor.BLACK, RgbColor.RED),
				Arrays.asList(RgbColor.RED, RgbColor.RED, RgbColor.RED, RgbColor.RED, RgbColor.RED));
		...
		final List<List<RgbColor>> expectedColors5 = Arrays.asList(
				Arrays.asList(RgbColor.RED, RgbColor.RED, RgbColor.RED, RgbColor.RED, RgbColor.RED),
				Arrays.asList(RgbColor.YELLOW, RgbColor.GREEN, RgbColor.GREEN, RgbColor.GREEN, RgbColor.YELLOW),
				Arrays.asList(RgbColor.RED, RgbColor.GREEN, RgbColor.BLACK, RgbColor.GREEN, RgbColor.RED),
				Arrays.asList(RgbColor.YELLOW, RgbColor.GREEN, RgbColor.GREEN, RgbColor.GREEN, RgbColor.YELLOW),
				Arrays.asList(RgbColor.RED, RgbColor.BLACK, RgbColor.BLACK, RgbColor.BLACK, RgbColor.RED),
				Arrays.asList(RgbColor.RED, RgbColor.RED, RgbColor.RED, RgbColor.RED, RgbColor.RED));
		...
		final List<List<RgbColor>> expectedColors10 = Arrays.asList(
				Arrays.asList(RgbColor.RED, RgbColor.RED, RgbColor.RED, RgbColor.RED, RgbColor.RED),
				Arrays.asList(RgbColor.YELLOW, RgbColor.GREEN, RgbColor.GREEN, RgbColor.BLACK, RgbColor.YELLOW),
				Arrays.asList(RgbColor.RED, RgbColor.BLACK, RgbColor.GREEN, RgbColor.BLACK, RgbColor.RED),
				Arrays.asList(RgbColor.YELLOW, RgbColor.GREEN, RgbColor.GREEN, RgbColor.BLACK, RgbColor.YELLOW),
				Arrays.asList(RgbColor.RED, RgbColor.BLACK, RgbColor.BLACK, RgbColor.BLACK, RgbColor.RED),
				Arrays.asList(RgbColor.RED, RgbColor.RED, RgbColor.RED, RgbColor.RED, RgbColor.RED));
		...
		final List<List<RgbColor>> expectedColors11 = Arrays.asList(
				Arrays.asList(RgbColor.RED, RgbColor.RED, RgbColor.RED, RgbColor.RED, RgbColor.RED),
				Arrays.asList(RgbColor.YELLOW, RgbColor.GREEN, RgbColor.BLACK, RgbColor.BLACK, RgbColor.YELLOW),
				Arrays.asList(RgbColor.RED, RgbColor.GREEN, RgbColor.BLACK, RgbColor.BLACK, RgbColor.RED),
				Arrays.asList(RgbColor.YELLOW, RgbColor.GREEN, RgbColor.BLACK, RgbColor.BLACK, RgbColor.YELLOW),
				Arrays.asList(RgbColor.RED, RgbColor.BLACK, RgbColor.BLACK, RgbColor.BLACK, RgbColor.RED),
				Arrays.asList(RgbColor.RED, RgbColor.RED, RgbColor.RED, RgbColor.RED, RgbColor.RED));
